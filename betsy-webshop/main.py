...
def remove_product(product_id):
    try:
        product = Product.get(Product.user == product_id)
...
def run_tests():
    ...
    user_products = list_user_products(2)
    print("User Products:")
    ...
    product = {
        "name": "Yu-Gi-Oh Cards",
        "description": "Yugi Moto playing cards",
        "price": 7.99,
        "quantity": 20,
        "tags": ["Accessories"]
    }
    ...
    if removed:
        ...
        print("Remove product unsuccesful")
    print()
    ...
    if updated:
        ...
        print("Updating stock quantity unsuccesful")
    print()
    ...
    if purchased:
        ...
        print("Unsuccesful to purchase product")
    print()
